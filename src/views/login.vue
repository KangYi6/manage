  ...
  <div class="login-wrap">
    <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="demo-ruleForm login-container">
      ...
      <el-row>
        ...
        <v-sidentify style="padding-left: 40px;" @input="createValidCode" :key="keyid"></v-sidentify>
      </el-row>
  ...
  methods: {
    ...
    submitForm() {
      ...
      if(!this.ruleForm.username){
        ...
        return
      }else if(this.ruleForm.code.toLowerCase()!=this.validCode.toLowerCase()){
        this.$message.error('验证码错误')
        this.keyid++
        return
      }
          this.$axios({
            url:this.$baseURL+'/manage/login/index.html',
            method:'POST',
            data:{
            ...
            if(res.code==1000){
              ...
              this.$router.push({ path: '/Education/User' })
            }else{
              this.keyid++
